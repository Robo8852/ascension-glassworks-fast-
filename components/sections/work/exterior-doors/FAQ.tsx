...
import { EXTERIOR_DOOR_FAQS } from './faqs';
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          {EXTERIOR_DOOR_FAQS.map((item, index) => {
            const isOpen = openIndex === index;
            const panelId = `door-faq-panel-${index}`;
            const buttonId = `door-faq-button-${index}`;
