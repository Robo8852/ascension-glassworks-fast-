    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <SectionHeadline className="flex flex-col items-center text-center">
          Match the Assembly to the Address
        </SectionHeadline>
        ...
        >
          Site visit, exposure-category lookup, wind-pressure calculation,
          and a written quote with full NOA documentation. No fee, no
          pressure — we&apos;d be glad to take a look.
        </motion.p>
        ...
        {/* Sibling-discipline link bar */}
        <motion.div
          initial={{ opacity: 0, y: 12 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-80px' }}
          transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1], delay: 0.3 }}
          className="mt-10 md:mt-12 text-[10px] md:text-[11px] tracking-[0.2em] uppercase text-brand-white/55 font-sans font-light"
        >
          <span>Also see: </span>
          <Link
            href="/work/window-replacement"
            className="text-brand-white/80 hover:text-gold transition-colors duration-300 underline decoration-white/15 underline-offset-4 hover:decoration-gold"
          >
            Window Replacement
          </Link>
          <span className="mx-2 text-gold/50" aria-hidden="true">·</span>
          <Link
            href="/work/exterior-doors"
            className="text-brand-white/80 hover:text-gold transition-colors duration-300 underline decoration-white/15 underline-offset-4 hover:decoration-gold"
          >
            Exterior Doors
          </Link>
