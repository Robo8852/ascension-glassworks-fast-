...
import { ShieldCheck, Gauge, FileCheck2 } from 'lucide-react';
import { SectionHeadline } from '../../../SectionHeadline';

const TRUST_PILLS = [
  { icon: ShieldCheck, label: 'ASTM E1886 / E1996 Tested' },
  { icon: Gauge, label: 'ASCE 7-22 Design-Pressure Matched' },
  { icon: FileCheck2, label: 'WBDR-Compliant for Permitting & Insurance' },
];
        ...
        >
          <motion.div variants={itemVariants}>
            <span className="inline-block text-[11px] md:text-xs tracking-[0.25em] uppercase text-gold font-sans font-medium mb-6">
              The Work · Impact Products
            </span>
          </motion.div>

          <motion.div variants={itemVariants}>
            <SectionHeadline>
              Hurricane-Rated Windows &amp; Doors, Documented to Code
            </SectionHeadline>
          </motion.div>
          ...
          >
            Impact assemblies are not films or shutters — they are tested
            systems with their own FL# or Miami-Dade NOA, ASCE 7-22 design
            pressure, and install discipline. We specify, install, and
            document them so the permit clears, the inspector signs, and
            the wind-mitigation credit lands on your policy.
          </motion.p>
