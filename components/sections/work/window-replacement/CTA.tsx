  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          Site visit, measurements, frame and operating-style recommendation,
          and a written quote. No fee, no pitch, no pressure.
        </motion.p>
        ...
        <motion.div
          ...
          className="mt-12 md:mt-16 text-[11px] md:text-xs tracking-[0.2em] uppercase text-brand-white/55 font-sans font-light"
        >
          <span className="text-brand-white/70">Also see:</span>{' '}
          <Link
